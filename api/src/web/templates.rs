...
pub struct AppDetailTemplate<'a> {
    ...
    pub binary_artifact_version: &'a str,
    pub binary_artifact_path: &'a str,
    pub binary_exec_args: &'a str,
    pub binary_service_user: &'a str,
    pub binary_unit_name: &'a str,
    pub binary_release_strategy: &'a str,
    pub binary_release_strategy_label: &'a str,
    pub binary_active_slot: &'a str,
    pub binary_standby_slot: &'a str,
    pub binary_base_port: i64,
    pub binary_standby_port: i64,
    pub binary_proxy_enabled: bool,
    pub binary_proxy_kind: &'a str,
    pub binary_proxy_kind_label: &'a str,
    pub binary_proxy_domain: &'a str,
    pub binary_proxy_config_path: &'a str,
    pub binary_unit_path: &'a str,
    pub binary_env_path: &'a str,
    pub binary_blue_unit_path: &'a str,
    pub binary_blue_env_path: &'a str,
    pub binary_green_unit_path: &'a str,
    pub binary_green_env_path: &'a str,
    pub binary_release_path: &'a str,
    pub binary_current_path: &'a str,
    pub binary_unit_content: &'a str,
    pub binary_env_content: &'a str,
    pub binary_blue_unit_content: &'a str,
    pub binary_blue_env_content: &'a str,
    pub binary_green_unit_content: &'a str,
    pub binary_green_env_content: &'a str,
    pub binary_release_content: &'a str,
    pub binary_current_content: &'a str,
