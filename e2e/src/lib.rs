...
async fn run_checks(
    ...
    anyhow::ensure!(
        templates.contains("<section class=\"panel panel-large panel-full list-panel\"")
            ...
            && templates.contains("id=\"template-preview-compose-redis-single\"")
            && templates.contains("id=\"template-preview-env-redis-single\"")
            && templates.contains("data-template-code-tab")
